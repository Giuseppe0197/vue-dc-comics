<template>
    <section>
      ...
      <button id="series">Current Series</button>

      <div id="thumbsDc">

        <div id="thumbsContainer">

        <!-- inserimento componente da creare con un ciclo v-for e stampare tutte le miniature dei fumetti -->
        <!-- <div class="thumbsComics">
            <img src="https://www.dccomics.com/sites/default/files/styles/covers192x291/public/comic-covers/2018/09/AC1000_DLX_162-001_HD_5ba13723281ab0.37845353.jpg?itok=ZsI-C5eX" alt="">
            <p>Action Comics</p>
        </div> -->
        <thumbComp v-for="comics, i in thumbsComics" :key="i" :details="comics"/>
